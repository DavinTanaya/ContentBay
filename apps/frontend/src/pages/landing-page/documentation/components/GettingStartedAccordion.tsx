...
export function GettingStartedAccordion() {
  ...
  const docs = [
      ...
      content: (
        <div className="space-y-6">
          <p className="text-slate-600">
            To interact with the ContentBay API, you can use the browser's
            built-in fetch API or Node.js fetch, or optionally install the
            ContentBay SDK helper library:
          </p>
          <div className="bg-slate-900 rounded-xl p-6 font-mono text-sm relative group">
            ...
            <p className="text-blue-300">
              npm <span className="text-white">install contentbay-sdk</span>
            </p>
          </div>
          <div className="bg-blue-50 border border-blue-100 p-4 rounded-xl flex items-start gap-3">
            ...
            <p className="text-sm text-blue-800">
              <span className="font-bold">Optional:</span> The SDK is optional.
              You can also use the REST API directly with fetch without any
              installation.
            </p>
          </div>
        </div>
    ...
    },
    {
      ...
      content: (
        <p className="text-slate-600">
          Configure your project with the API keys provided in your
          dashboard...
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-slate-600">
          Start by creating your first content model using the visual
          builder...
        </p>
      ),
    },
    {
      ...
      content: (
        <p className="text-slate-600">
          Use our powerful query engine to fetch exactly the data you need...
        </p>
      ),
    },
  ];
