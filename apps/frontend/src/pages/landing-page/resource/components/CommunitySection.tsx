        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            <div 
              ...
              style={{ backgroundImage: 'linear-gradient(90deg, #0050B3 0%, #096DD9 100%)' }}
            >
              Community
            </div>
            ...
            <div className="space-y-6 max-w-[545px]">
              <Button
                className="!rounded-[56px] border-none text-white flex items-center justify-between gap-8 hover:opacity-90 transition-opacity shadow-xl group"
                style={{
                  backgroundImage:
              ...
              >
                <div className="flex items-center gap-8">
                  <img
                    src="/landing-page/resources/github.svg"
                    className="w-10 h-10"
                    alt="Github"
                  />
              ...
              >
                <div className="flex items-center gap-8">
                  <img
                    src="/landing-page/resources/discord.svg"
                    className="w-10 h-10"
                    alt="Discord"
                  />
                  <span className="font-medium text-[16px] leading-[24px] text-white font-['Poppins']">
          ...
          <div className="flex-1 relative">
            <img
              src="/landing-page/resources/resources_community.jpg"
