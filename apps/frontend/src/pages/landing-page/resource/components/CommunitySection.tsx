        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1">
            ...
            <h2 className="text-[52px] font-bold text-slate-900 mb-6 leading-[1.1]">
              Join our{' '}
              <span className="text-[#0061D1]">developer community</span>
            </h2>
            ...
            <div className="space-y-8 max-w-lg">
              <Button
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(to right, #003B8D, #0052C1)',
                  height: '72px',
                  paddingTop: '20px',
                  paddingBottom: '20px',
                }}
              ...
              <Button
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(to right, #4E71FF, #6384FF)',
                  height: '72px',
                  paddingTop: '20px',
                  paddingBottom: '20px',
                }}
