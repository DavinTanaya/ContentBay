...
/**
 * ContentModelCard — a passive/dumb UI card for displaying a content model.
 * Navigation is handled by the parent (page/widget), NOT by this entity component.
 */
export const ContentModelCard: FC<ContentModelCardProps> = ({ model, onClick }) => {
  return (
    <Card 
      hoverable
