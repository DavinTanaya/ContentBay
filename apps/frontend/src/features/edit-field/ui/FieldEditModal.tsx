      ...
      <div className="px-12 py-8 space-y-12">
        ...
        <div>
          ...
          <div className="grid grid-cols-2 gap-6">
            {[
              { label: 'Required Field', desc: 'Cannot be empty when publishing', checked: field.required },
        ...
        <div className="flex justify-end gap-3 pt-4 pb-4">
          <Button className="h-12 px-8 rounded-xl font-bold border-gray-200 text-gray-500" onClick={onClose}>
            Cancel
          </Button>
          <Button type="primary" className="h-12 px-10 rounded-xl font-bold bg-[#2563EB] border-none shadow-lg shadow-blue-600/20" onClick={onClose}>
            Confirm Changes
          </Button>
        </div>
      </div>
