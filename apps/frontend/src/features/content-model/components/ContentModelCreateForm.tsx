      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex justify-between items-start mb-12">
          <div className="max-w-2xl">
            <h1 className="text-[40px] font-bold text-gray-900 leading-tight mb-4">Create new content type</h1>
            <p className="text-gray-500 text-lg font-medium leading-relaxed">
              Define the structure for your content. A content type acts as a template for your entries.
            </p>
          </div>
        ...
        <div className="bg-white rounded-[40px] border border-gray-200 p-16 shadow-sm shadow-blue-900/5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 mb-12">
            <div className="space-y-10">
              <div>
                <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">Name</label>
                <Input 
                ...
                />
                <p className="text-[11px] text-gray-400 mt-3 font-medium">Appear in the menu and entry lists</p>
              </div>

              <div>
                <label className="block text-[11px] font-bold text-gray-400 uppercase tracking-[0.2em] mb-4">API Identifier</label>
                <Input 
                ...
                />
                <p className="text-[11px] text-gray-400 mt-3 font-medium">Used in API responses. Auto-generated from name.</p>
              </div>
            </div>
        ...
        <div className="mt-12 p-8 bg-[#2563EB]/5 rounded-[32px] border border-[#2563EB]/10 flex items-start gap-6">
          ...
          <div>
            <h4 className="text-[#2563EB] font-bold text-sm mb-1 tracking-tight">Pro Tip</h4>
            <p className="text-[#2563EB]/60 text-xs font-medium leading-relaxed">
              Start with a clear name. You can always change the display name later, but the API identifier is permanent to ensure your applications don't break.
            </p>
          </div>
        </div>
      </div>
