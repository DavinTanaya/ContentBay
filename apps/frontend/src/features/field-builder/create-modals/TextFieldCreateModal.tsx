...
interface TextFieldCreateModalProps {
  ...
  onClose: () => void;
  onBack: () => void;
  onProceed: (data: TextField) => void;
}

export function TextFieldCreateModal({ isOpen, onClose, onBack, onProceed }: TextFieldCreateModalProps) {
    ...
    >
      <div className="mt-4">
        ...
        <div className="space-y-6">
          ...
          <div>
            <label className="block text-sm font-semibold text-gray-9 mb-2">Storage Type</label>
