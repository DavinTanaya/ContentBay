        ...
        <div className="p-16">
          <div className="flex items-center gap-6 mb-12">
            <div
              ...
              style={{
                backgroundColor: `${selectedFieldType?.color || '#2563EB'}10`,
                color: selectedFieldType?.color || '#2563EB',
              }}
            >
          ...
          <div className="space-y-10">
            <div className="grid grid-cols-2 gap-8">
              <div>
                ...
                <Input
                  defaultValue={selectedFieldType?.title}
              ...
              <div>
                ...
                <Input
                  defaultValue={selectedFieldType?.title.toLowerCase()}
          ...
          <div className="w-72 border-r border-gray-50 p-10 space-y-3 bg-gray-50/20">
            <div className="mb-10 pl-2">
              <Tag
                ...
                style={{
                  backgroundColor: `${selectedFieldType?.color || '#2563EB'}15`,
                  color: selectedFieldType?.color || '#2563EB',
                }}
              >
